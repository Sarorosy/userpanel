...
function TopSellers() {
  ...
  useEffect(() => {
    const fetchTopSellers = async () => {
      try {
        setLoading(true);
        const response = await axios.get('https://ryupunch.com/leafly/api/Strains/get_topsellers');
  ...
  return (
    <div className="container mx-auto p-4 mt-4">
      <h1 className="text-2xl font-bold mb-4 flex items-center space-x-2">Top Sellers <img src={topsellericon} className='w-12 h-auto' alt='Green Mart Top Seller'/></h1>
      {loading ? (
